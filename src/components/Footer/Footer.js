...
function Footer() {
  return (
    <footer>
      <Grid className="footer-holder" container>
        <Grid className="footer-wrapper" item xs={12} sm={12} md={8}>
          ...
          <p className="text-footer">
            ...
            همچنین استعدادیابی و استعدادپروری کودکان و نوجوانان، با تکیه بر دانش
            روز و تجارب اساتید و کســــــــــب و کار و رویش و شکوفایی استعداد،
            با نگاه بومی و رویکردی جامع در تلاش است خدماتی موثر و نقش آفرین در
            حوزه های شتابدهی مرکز توسعه کسب و کار روشا متناظر با اهداف مرکز
            نوآوری دانشکده روانشناسی و علوم تربیتی دانشگاه تهران در دو حوزه
            تخصصی مشـاوره
          </p>
        </Grid>
        <Grid className="footer-logos-holder" item xs={12} sm={12} md={4}>
       ...
       <a referrerpolicy="origin" target="_blank" rel="noopener" href="https://trustseal.enamad.ir/?id=214787&amp;Code=wurFrWjixpUFsopis8yj"> <img height="" width="" loading="lazy"  referrerpolicy="origin" src="https://Trustseal.eNamad.ir/logo.aspx?id=214787&amp;Code=wurFrWjixpUFsopis8yj" alt="" style="cursor:pointer" id="wurFrWjixpUFsopis8yj"/></a>
        <img src=""/>
          ...
          <div className="social-holder">
            <a className="img-logo-footer" href="">
              <img src={video} />
            </a>
            <a className="img-logo-footer" href="">
              <img src={instgram} />
      ...
      <div className="copy-right">سال ۱۳۴۰۰</div>
    </footer>
  );
}
